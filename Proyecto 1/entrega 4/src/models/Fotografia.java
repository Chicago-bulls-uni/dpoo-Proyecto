...
public class Fotografia extends Pieza{
	...
	public Fotografia(int idPiezaP,String nombreP, boolean bloqueadaP, String autorP,  int anioP, String lugarCreacionP,
			String tipoPiezaP,Date fechaing, GeneroFotografico generoFotograficoP,EstadoPieza estadopiece, String contactoPropietario) {
		super(idPiezaP,nombreP,tipoPiezaP, bloqueadaP, autorP,  anioP, lugarCreacionP, fechaing,estadopiece, contactoPropietario);
