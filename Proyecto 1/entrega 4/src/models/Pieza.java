...
public class Pieza {
    ...
    public Pieza(int idPiezaP,String nombre, String tipo, boolean bloqueadaP, String autorP,  int anioP, String lugarCreacionP, Date fechaIngresa,EstadoPieza estadopiece, String contactoPropietario) {
